...
enum StoryboardScene {
  ...
  enum Main: String, StoryboardSceneType {
    ...
    case sidePanelScene = "SidePanel"
    static func instantiateSidePanel() -> SSS.SidePanelViewController {
      guard let vc = StoryboardScene.Main.sidePanelScene.viewController() as? SSS.SidePanelViewController
      else {
        fatalError("ViewController 'SidePanel' is not of the expected class SSS.SidePanelViewController.")
      }
      return vc
    }
  }
