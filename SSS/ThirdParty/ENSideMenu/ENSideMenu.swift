...
*/
    ...
    */
    ...
    fileprivate func setupMenuView() {
        ...
        sideMenuContainerView.layer.shadowOpacity = 0
        ...
        if (NSClassFromString("UIVisualEffectView") != nil) {
            ...
            visualEffectView.frame = CGRect(x: 0, y: 0, w: sideMenuContainerView.bounds.width - 72, h: sideMenuContainerView.bounds.height)
